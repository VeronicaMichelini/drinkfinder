...
if( empty($_POST["username"]) )
	...
	// assegno l'username inserito dall'utente alla variabile username
...
if( empty($_POST["password"]) )
	...
	// assegno la password inserita dall'utente alla variabile password
	$password = ($_POST["password"]);

    
// validazione delle credenziali
// se le variabili username_err e password_err significa che entrambi i campi sono stati inseriti
	...
	empty($password_err))
{
	for($i = 0; $i < count($utenti); $i++)
	{
		if(($utenti[$i]['username'] == $username) && 
			...
			// assegno alla variabile username_err un messaggio di errore
